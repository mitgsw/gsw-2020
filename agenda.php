...
<div class="parallax-window header2" data-parallax="scroll" style="background-image: url('assets/images/grenoble/General2.png');">
    ...
    <div class="row text-center" style="margin: auto; width:85%">
        ...
        <div class="col-lg-12 agenda-white">
            ...
            <div class="col-sm-6">
                ...
                <a href="speakers.php"><h2 style="font-weight: 900" class="agenda-black"> Richard Lester</h2></a>
                <i><h4 style="font-weight: 900" class="agenda-black"> Associate Provost for International Activities, MIT</h4></i>
        ...
        <div class="col-lg-12 agenda-white">
            ...
            <div class="col-sm-6">
                <h5 class="agenda-black"> End of Day One</h5>
            </div>
            <div class="col-sm-3"></div>
        </div>
        ...
        <div class="col-lg-12 agenda-white">
            ...
            <div class="col-sm-6">
                <a href='epc.php'><div class="agenda-showcase">
                    <h2 class="agenda-black"> Elevator Pitch Competition</h2>
                </div></a>
                <br>
            </div>
            <div class="col-sm-3"></div>
